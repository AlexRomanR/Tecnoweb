    ...
    */
    'accounts' => [
        ...
        /* 'default' => [// account identifier
            'host'  => env('IMAP_HOST', 'mail.tecnoweb.org.bo'),
            'port'  => env('IMAP_PORT', 110),
            'protocol'  => env('IMAP_PROTOCOL', 'imap'), //might also use imap, [pop3 or nntp (untested)]
            'encryption'    => env('IMAP_ENCRYPTION', 'POP3'), // Supported: false, 'ssl', 'tls', 'notls', 'starttls'
            'validate_cert' => env('IMAP_VALIDATE_CERT', true),
            'username' => env('IMAP_USERNAME', 'grupo07sc'),
            'password' => env('IMAP_PASSWORD', 'grup007grup007'),
